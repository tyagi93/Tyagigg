...
async def buttons(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    if query.data == "help":
        await query.message.reply_text("Send any valid 10-digit mobile number.")
...
# ==========================================
# API LOOKUP SYSTEM (CLEANED VERSION)
# ==========================================
async def lookup(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    try:
        ...
        # Faltu ke owner aur admin usernames ko automatic saaf karne ke liye logic
